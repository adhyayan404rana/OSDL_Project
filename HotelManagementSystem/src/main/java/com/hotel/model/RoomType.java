...
/**
 * RoomType Enum — demonstrates ENUMERATIONS with constructor
...
public enum RoomType {
        ...
        DELUXE(4500.0, "Spacious room with city view and premium furnishing", 2,
                        Arrays.asList("High-Speed Wi-Fi", "City View", "Premium Bedding", "Mini Fridge",
                                        "Daily Housekeeping"),
                        "/com/hotel/images/rooms/deluxe.jpg"),

        EXECUTIVE(6000.0, "Business-class room with dedicated work space", 2,
                        Arrays.asList("High-Speed Wi-Fi", "Work Desk", "Complimentary Coffee", "Ironing Station",
                                        "Meeting Room Access"),
        ...
        SUITE(8000.0, "Luxury suite with separate living area", 3,
                        Arrays.asList("High-Speed Wi-Fi", "Living Room", "Premium Minibar", "Bathrobe & Slippers",
                                        "Room Service 24x7"),
                        "/com/hotel/images/rooms/suite.jpg"),

        PENTHOUSE(15000.0, "Top-floor penthouse with panoramic views and private terrace", 4,
                        Arrays.asList("Fibre Wi-Fi", "Private Terrace", "Panoramic View", "Personal Butler", "Jacuzzi",
                                        "Premium Minibar"),
                        "/com/hotel/images/rooms/penthouse.jpg"),

        VILLA(20000.0, "Private villa with garden, pool, and full kitchen", 6,
                        Arrays.asList("Fibre Wi-Fi", "Private Pool", "Garden", "Full Kitchen", "Personal Chef",
                                        "Spa Access", "Airport Transfer"),
